...
/**
  * A Spec is used to describe the behavior of a Class.
  */
@ScalaJSDefined
abstract class Spec[P, S] extends js.Object {
  ...
  /**
    ...
    */
  val getInitialState: js.UndefOr[
    js.ThisFunction0[Component[P, S], State[S]]
    ] = None.orUndefined
  ...
  /**
    ...
    * not copied.
    */
  def getDefaultProps(): js.UndefOr[
    Props[P]
    ] = None.orUndefined
  ...
  /**
    ...
    */
  val componentWillMount: js.UndefOr[
    js.ThisFunction0[Component[P, S], Unit]
    ] = None.orUndefined
  ...
  /**
    ...
    */
  val componentDidMount: js.UndefOr[
    js.ThisFunction0[Component[P, S], Unit]
    ] = None.orUndefined
  ...
  /**
    ...
    */
  val componentWillReceiveProps: js.UndefOr[
    js.ThisFunction1[Component[P, S], Props[P], Unit]
    ] = None.orUndefined
  ...
  /**
    ...
    * speed up your app.
    */
  val shouldComponentUpdate: js.UndefOr[
    js.ThisFunction2[
      Component[P, S],
      Props[P],
      State[S],
  ...
  /**
    ...
    */
  val componentWillUpdate: js.UndefOr[
    js.ThisFunction2[
      Component[P, S],
      Props[P],
      State[S],
  ...
  /**
    ...
    */
  val componentDidUpdate: js.UndefOr[
    js.ThisFunction2[
      Component[P, S],
      Props[P],
      State[S],
  ...
  /**
    ...
    */
  val componentWillUnmount: js.UndefOr[
    js.ThisFunction0[
      Component[P, S],
      Unit
      ]
